  ...
  return (
    ...
    <Container>
        ...
        <Flex className={"gap-x-7"}>
            <div className='w-1/4'>
                <Product productImg={bestSellersOne} badgeText={"New"}productTitle={"Basic Crew Neck Tee"} productPrice={"$44.00"}/>
            </div>
            <div className='w-1/4'>
                <Product  productImg={bestSellersTwo} badgeText={"New"}productTitle={"Basic Crew Neck Tee"} productPrice={"$44.00"}/>
            </div>
            <div className='w-1/4'>
                <Product productImg={bestSellersThree} badgeText={"New"}productTitle={"Basic Crew Neck Tee"} productPrice={"$44.00"}/>
            </div>
            <div className='w-1/4'>
