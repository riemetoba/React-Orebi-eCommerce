    ...
    <>
      <Container>
        ...
        <div className="relative px-4 md:px-0 group">
          ...
          <div className="swiper-button-prev-custom hidden md:block absolute left-0 top-[50%] -translate-y-1/2 z-10 cursor-pointer">
            <PrevArrow />
          </div>
          <div className="swiper-button-next-custom hidden md:block absolute right-0 top-[50%] -translate-y-1/2 z-10 cursor-pointer">
            <NextArrow />
          </div>
        </div>
      </Container>
